...
// We will write a lightweight PowerShell script to load the bitmap, crop whitespace,
// generate:
// 1. logo-light.png: Transparent PNG with dark navy letters & orange trident
// 2. logo-dark.png: Transparent PNG with pure white letters & orange trident (for dark backgrounds)
// 3. favicon.png / icon.png: The orange trident mark alone
...
fs.writeFileSync('scripts/process-logo.ps1', psScript);
console.log('Generated scripts/process-logo.ps1');
